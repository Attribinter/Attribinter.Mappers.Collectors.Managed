...
public sealed class Register
{
    ...
    private static void Target<TParameter, TRecord, TArgumentData, TParameterFactory, TRecorderFactory>(IRegistratorFixture<TParameter, TRecord, TArgumentData, TParameterFactory, TRecorderFactory> fixture, IParameterMappingCollector<TParameter, TRecord, TArgumentData> collector)
