...
public interface IManagedArgumentDataRecorderMappingRegistrator<out TParameter, in TRecord, in TArgumentData, in TParameterFactory, in TRecorderFactory>
{
    ...
    public abstract void Register(
        IManagedArgumentDataRecorderMappingRegistratorContext<TParameter, TRecord, TArgumentData, TParameterFactory, TRecorderFactory> context);
}
