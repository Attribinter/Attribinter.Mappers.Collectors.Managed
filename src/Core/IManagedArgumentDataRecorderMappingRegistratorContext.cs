...
/// <summary>Provides context for <see cref="IManagedArgumentDataRecorderMappingRegistrator{TParameter, TRecord, TArgumentData, TParameterFactory, TRecorderFactory}"/>.</summary>
...
public interface IManagedArgumentDataRecorderMappingRegistratorContext<in TParameter, out TRecord, out TArgumentData, out TParameterFactory, out TRecorderFactory>
{
    /// <summary>Collects mappings from parameters to recorders.</summary>
    public abstract IArgumentDataRecorderMappingCollector<TParameter, TRecord, TArgumentData> Collector { get; }
